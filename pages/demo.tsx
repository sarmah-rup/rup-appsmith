    ...
    <main className="flex  flex-col p-6" style={{margin:'0px'}}>
     <div className="container mx-auto" style={{marginTop:'100px'}}>
      ...
      <span>
        ...
        <span className="relative inline-block bg-gradient-to-br from-primary-light-500 to-primary-light-300 font-display text-4xl" style={{ backgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent', lineHeight:'1.2' }}>
          Enterprise scale
